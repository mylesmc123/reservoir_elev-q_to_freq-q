...
with HecDss.Open(dss_file) as dss:
    ...
    lawtonka_path = "/Lake Lawtonka near Lawton, OK/07309500/STAGE//15Minute/USGS/"
    # ellsworth_path = "/Lake Ellsworth near Lawton, OK/07310000/STAGE//15Minute/USGS/"
    ellsworth_path = "/Lake Ellsworth near Elgin, OK/07308990/STAGE/01Oct2007 - 18Jun2025/15Minute/USGS/"
...
lawtonka_path_outflow = lawtonka_path.replace("STAGE", "RES FLOW-OUT")
ellsworth_path_outflow = ellsworth_path.replace("STAGE", "RES FLOW-OUT")
...
for (pathname, df) in zip([lawtonka_path_outflow, ellsworth_path_outflow], [lawtonka_df, ellsworth_df]):
    ...
    with HecDss.Open(dss_file, "w") as fid:
